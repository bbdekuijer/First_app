...
# Bereken percentages per partij voor West
west_row = stadsdeel_data[stadsdeel_data['Stadsdeel'] == 'West'].iloc[0]
for partij in partij_columns:
    stadsdeel_data.loc[stadsdeel_data['Stadsdeel'] == 'West', partij + ' %'] = (west_row[partij] / west_row['Total Votes']) * 100

# Functie om taartdiagrammen te maken voor West
...
st.image(img_bytes, caption=f"Stemverdeling in {west_row['Stadsdeel']}", use_column_width=True)
