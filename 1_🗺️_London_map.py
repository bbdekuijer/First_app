...
# Toon de legende buiten de kaart in Streamlit
st.markdown("""
### Station Types Legend
- <span style="color:red">⬤ Zone 1</span>
- <span style="color:orange">⬤ Zone 2</span>
- <span style="color:yellow">⬤ Zone 3</span>
- <span style="color:yellowgreen">⬤ Zone 4</span>
- <span style="color:green">⬤ Zone 5</span>
- <span style="color:cyan">⬤ Zone 6</span>
